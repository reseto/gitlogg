...
parser._transform = function(data, encoding, done) {
  ...
  var repository =                     c[3],                    // color-consolidator
      ...
      author_name =                    unquote(c[17]).toLowerCase(),          // Wallace Sidhrée
      author_name_mailmap =            unquote(c[19]).toLowerCase(),          // Wallace Sidhrée
      author_email =                   c[21].toLowerCase(),                   // i@dreamyguy.com
      author_email_mailmap =           c[23].toLowerCase(),                   // i@dreamyguy.com
      ...
      committer_name =                 unquote(c[37]).toLowerCase(),          // Wallace Sidhrée
      committer_name_mailmap =         unquote(c[39]).toLowerCase(),          // Wallace Sidhrée
      committer_email =                c[41].toLowerCase(),                   // i@dreamyguy.com
      committer_email_mailmap =        c[43].toLowerCase(),                   // i@dreamyguy.com
